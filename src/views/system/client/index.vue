...
const { loading, ids, multiple, queryParams, clientList, total, dialog, formData, rules, authorizedGrantTypesOptions, checkedAuthorizedGrantTypes } =
	toRefs(state);
...
function submitForm() {
	dataFormRef.value.validate((isvalid: boolean) => {
		if (isvalid) {
			state.formData.authorizedGrantTypes = state.checkedAuthorizedGrantTypes.join(',');
	...
	<div class="app-container">
		...
		<el-form ref="queryFormRef" :model="queryParams" :inline="true">
			...
			<el-form-item prop="clientId">
				<el-input v-model="queryParams.clientId" placeholder="输入客户端ID" clearable style="width: 240px" @keyup.enter="handleQuery" />
			</el-form-item>
