...
import { listRolePages, updateRole, getRoleFormDetail, addRole, deleteRoles } from '@/api/system/role';
...
const { loading, multiple, queryParams, roleList, total, dialog, formData, rules } = toRefs(state);
