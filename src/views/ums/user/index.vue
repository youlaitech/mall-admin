<template>
  <div class="app-container">
    ...
    <el-dialog top="1vh" title="会员充值" :visible.sync="dialog.visible" width="700px">
      <h1 class="mod-title">
        <!--支付宝支付图标-->
      ...
      <div class="mod-ct">
        <div class="amount" id="money">
          <span style="color:#F56C6C;">充值1元就送有来商城10000元体验金</span>
        </div>
        ...
        <div class="time-item" style="padding-top: 10px">
          ...
          <div class="time-item">
            ...
            <strong id="minute_show"><s>{{countdown.m}}</s></strong>
            <strong id="second_show"><s>{{countdown.s}}</s></strong>
