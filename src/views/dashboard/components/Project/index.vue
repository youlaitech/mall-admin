	...
	<div class="component-container">
		<el-card class="project-card">
			...
			<div class="project-card__main">
				<!-- 项目简介 -->
				<el-link target="_blank" type="primary" href="https://gitee.com/haoxr"> youlai-mall </el-link>
				是基于Spring Boot 2.6、Spring Cloud 2021 & Alibaba 2021、Vue3、Element-Plus、uni-app等主流技术栈构建的一整套全栈开源商城项目， 涉及
				...
				、
				<el-link target="_blank" type="warning" href="https://gitee.com/youlaitech/youlai-mall-weapp">微信小程序 </el-link>
				和
				...
				<el-row :gutter="10">
					...
					<el-col :span="18"> Spring Boot、Spring Cloud & Alibaba、Spring Security OAuth2、JWT、Elastic Stack 、K8s... </el-col>
				</el-row>
				<el-divider />
				<el-row :gutter="10">
					<el-col :span="6" class="fw-b"> 前端技术栈 </el-col>
					<el-col :span="18"> Vue3、TypeScript、Element-Plus、uni-app、vue3-element-admin ... </el-col>
				</el-row>
			</div>
		</el-card>
	</div>
