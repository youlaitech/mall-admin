...
<template>
  <div class="app-container">
    ...
    &lt;!&ndash; 搜索表单::end &ndash;&gt;

    &lt;!&ndash; 数据表格::start &ndash;&gt;
    <el-table
      id="dataTable"
      ref="multipleTable"
      :data="pageList"
    ...
    &lt;!&ndash; 数据表格::end&ndash;&gt;

    &lt;!&ndash; 分页工具条::start &ndash;&gt;
    <pagination
    ...
    &lt;!&ndash; 分页工具条::end &ndash;&gt;

    &lt;!&ndash; 表单弹窗::start &ndash;&gt;
    <el-dialog
      :title="dialog.title"
