...
- [Enlace de Wiki](https://github.com/hxrui/wiki)
...
**Después de la versión `v4.1.0+`, la rama por defecto master no tendrá soporte para i18n. Por favor utilice la rama [i18n](https://github.com/hxrui/tree/i18n), los cambios serán incluidos en la rama master**

**la versión actual es `v4.0+` construida con `vue-cli`. Si encuentra algún problema, por favor coloque un [issue](https://github.com/hxrui/issues/new). Si desea usar la versión anterior, puede cambiar de rama a [tag/3.11.0](https://github.com/hxrui/tree/tag/3.11.0), no relacionado con `vue-cli`**
...
```bash
# clone el proyecto
git clone https://github.com/hxrui.git
...
Los cambios detallados por cada liberación se encuentran en [notas de liberación](https://github.com/hxrui/releases).
